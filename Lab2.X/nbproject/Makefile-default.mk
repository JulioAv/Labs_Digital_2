...
SOURCEFILES_QUOTED_IF_SPACED=Lab2.c ADC.c USART.c LCDh.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Lab2.p1 ${OBJECTDIR}/ADC.p1 ${OBJECTDIR}/USART.p1 ${OBJECTDIR}/LCDh.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/Lab2.p1.d ${OBJECTDIR}/ADC.p1.d ${OBJECTDIR}/USART.p1.d ${OBJECTDIR}/LCDh.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Lab2.p1 ${OBJECTDIR}/ADC.p1 ${OBJECTDIR}/USART.p1 ${OBJECTDIR}/LCDh.p1

# Source Files
SOURCEFILES=Lab2.c ADC.c USART.c LCDh.c
...
${OBJECTDIR}/LCDh.p1: LCDh.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/LCDh.p1.d 
	@${RM} ${OBJECTDIR}/LCDh.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto     -o ${OBJECTDIR}/LCDh.p1 LCDh.c 
	@-${MV} ${OBJECTDIR}/LCDh.d ${OBJECTDIR}/LCDh.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/LCDh.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
